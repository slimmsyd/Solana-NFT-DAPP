    ...
    const mintToken = async () => {
      ...
      if (candyMachine.state.whitelistMintSettings) {
        ...
        if (candyMachine.state.whitelistMintSettings.mode.burnEveryTime) {
          const whitelistBurnAuthority = solanaWeb3.Keypair.generate();
      ...
      if (candyMachine.state.tokenMint) {
        const transferAuthority = solanaWeb3.Keypair.generate();
      ...
      instructions.push(
        await candyMachine.program.instruction.mintNft(creatorBump, {
          accounts: {
            ...
            recentBlockhashes: solanaWeb3.SYSVAR_RECENT_BLOCKHASHES_PUBKEY,
            instructionSysvarAccount: solanaWeb3.SYSVAR_INSTRUCTIONS_PUBKEY,
          },
          remainingAccounts:
